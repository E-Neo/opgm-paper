...
Graphflow is able to match directed pattern graphs with both vertex labels and edge labels,
however, supports for multi-edges and WHERE clause are still missing.
