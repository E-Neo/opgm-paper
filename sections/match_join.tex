...
The planner of SeqStar first generates a join order based on the statistical parameters of SuperRows,
...
the join order can ensure the root of the stars are bound by previous stars.
