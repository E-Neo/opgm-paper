...
The candidate vertices ($4, 7, 9$) may match the root $u_4$.
Then SeqStar scans the candidate vertices sequentially and finds that only vertex $4, 7$ can matched ($8$ violates the constraint $u_4 < 8$).
