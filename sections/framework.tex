...
The intermediate results from star matching are not wrote down as conventional relationship rows,
...
The intermediate results could always be restored by doing Cartesian product on the compressed data.

Finally, SeqStar applies a novel pipeline join directly on the compressed data to obtain the final results.
TODO, add examples.
