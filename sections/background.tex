...
A \emph{property graph} is a directed graph with labelled vertices and edges.
It may also have self-loop which is an edge connecting to a same vertex.
...
Note that the total function $\rho_G$ is necessary because of the self-edges.
