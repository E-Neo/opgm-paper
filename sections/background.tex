...
A \emph{property graph} is a directed graph with labelled vertices and edges. It may also have self-edges with edges connecting to a same vertex. 
...
Please note that the total function $\rho_G$ is necessary because of the self-edges.
