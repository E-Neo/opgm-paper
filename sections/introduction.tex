...
To address this challenge, we make a balance by choosing stars (a root vertex together with the neighbors of it) as our basic unit,
which could keep the size of intermediate results less than $23\%$ of the data graph, as our experiment shows,
and do not rely on super-linear indices.
